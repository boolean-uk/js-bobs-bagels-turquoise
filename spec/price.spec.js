...
const menu = require("../src/inventory.js");
...
describe("Price", () => {
  ...
  it("returns the price of all items in the price.basket", () => {
    // set up
    const expected = 5.84;
    // execute
  ...
  it("total price.basket price before discount", () => {
    // set up
    const expected = 2.94;
    // execute
  ...
  it("discount amount", () => {
    ...
    // { BGLO: 7, BGLP: 1, BGLE: 1, BGLS: 1, COF: 1, BGSE: 1 }.discountAmount()
